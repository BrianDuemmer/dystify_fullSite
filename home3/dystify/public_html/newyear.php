<?php
	...
	$sql = "SELECT v.username, 
        SUBSTRING_INDEX(
            ...
            , 1) 
        AS song FROM ifttt_log i INNER JOIN viewers v ON v.user_id=i.user_id WHERE i.command='!eventrequest' ORDER BY song ASC, i.time ASC";
...
<div class="container">
		<div class="games">
		 <h3>New Year's Event 2018</h3>
                        <center><h4>Request songs to play during the event!</h4>
                        <a href="https://discord.gg/UjGfXcv" target="_blank" class="btn"><span>Discord</span></a><a href="songlist" target="_blank" class="btn"><span>Song List</span></a>
                        <p><u><b>How to request songs for this event</b></u></p>
                                    <pr>• Find the song you want to request (searching with CTRL + F helps) in the song list<br>
                                    • Check if the song is already added to the event playlist in the table below.<br>
                                    • If you request a song that has already been added you will not get a refund. Sorry.<br>
                                    • Type "<b>!eventrequest Your Game - Your Song</b>" in Youtube chat. You <b>must</b> copy paste the game/song for this to work.<br>
                                    • Please make sure to check for typos before you use the command!<br>
                                    • One request costs 300 Rupees. You may request as much as you want, as the event will run for a long time (12 hours+).<br>
                                    If you have any questions about this please feel free to ask us on Discord in #ask-mods or on the stream.</center>
                    </div>
				<ul id="da-thumbs" class="da-thumbs">
<p style="text-align: center;"><b><?php echo $GLOBALS['disp_txt']?></b></p>
<div class="bannerh2"><p style="text-align: center;">
	<div class="table"><table width="60%" align="center">
		<tbody>
			<tr> <th>Song</th> <th>Requested by</th> </tr>
