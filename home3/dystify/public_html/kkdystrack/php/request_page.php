<?php 
    ...
    function extractOstChildInfo($parent, $name) {
        if(count($parent) == 0) { // has no children, is a base layer OST
            return "<li class='ost'><span>$name</span></li>";
        } else { // has kids, gotta recursively get rid of them
            $html = "<li class='ostParent'><span>$name</span><ul>";
...
<html>
    <head>
        ...
        <link rel="stylesheet" type="text/css" href="https://dystify.com/css/theme.css" ></link>
        ...
        <script type="text/javascript">
            ...
            $(document).ready(function() {
                ...
                fetchQueue(queueTbl);
                setInterval(fetchQueue, 1000, queueTbl);

//                 alert(JSON.stringify(queueTbl));
                

                // Clicked on an OST
                $("#OstTree .ost").find("span").click(function () {
                    var getParams = {};
                ...
                openTab(null, "RequestsContainer");
        ...
        <div class="BodyContainer">
        	<div class="ContentContainer">
        		<div id="StreamContainer">
    				<iframe id='StreamVideo' height=100% width=100% src="https://www.youtube.com/embed/live_stream?channel=UC8CDnZ97yyp9k88dxZkApeQ&autoplay=1" frameborder="0" allowfullscreen ></iframe>
				</div>
				
				
				
				<div class="TabBar">
				 	<button class="TabLink" onclick="openTab(event, 'QueueContainer')">Queue</button>
          			<button class="TabLink active" onclick="openTab(event, 'RequestsContainer')">Request Songs</button>
				...
				<div id="TabContainer">
                	...
                	<div id="PlayHistoryContainer" class="TabElement">
